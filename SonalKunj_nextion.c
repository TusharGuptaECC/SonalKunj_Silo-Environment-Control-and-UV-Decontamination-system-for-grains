...
{
	uart_1_Print("n1.val=");
	uart_1_Transmit((unsigned char)settings[1]/10 + '0');
	uart_1_Transmit((unsigned char)settings[1]%10 + '0');
	...
	uart_1_Print("n0.val=");
	uart_1_Transmit((unsigned char)settings[0]/10 + '0');
	uart_1_Transmit((unsigned char)settings[0]%10 + '0');
	...
	// UV time
	uart_1_Print("n2.val=");
	uart_1_Transmit((unsigned char)settings[3]/10 + '0');
	uart_1_Transmit((unsigned char)settings[3]%10 + '0');
